...
const About = () => {
  return (
    <div className={styles.container}>
      <h1>About Our App</h1>
      <p>Welcome to our React.js app!</p>
      ...
      <ul>
        <li>
          User Authentication: Users can create a new account, log in with their
          credentials, and securely access their profile.
        </li>
        <li>
      ...
      <ol>
        ...
        <li>
          Explore your profile page, where you can view and manage your profile
          information.
        </li>
        <li>
          Feel free to update your profile image, edit your username and email,
          or change your password as needed.
        </li>
        <li>
          If you ever wish to delete your account, you can choose the "Delete
          Account" option.
        </li>
        <li>When you're done, you can sign out to end your current session.</li>
      </ol>

      <p>
        Thank you for choosing our app! We hope you have a great user experience
        and find our features helpful for managing your profile effectively.
      </p>
    </div>
  );
};
